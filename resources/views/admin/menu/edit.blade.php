{{-- 菜单修改内容 --}}
<div class="init" ng-init="id='{{$menu->id}}'"></div>
	...
	<form class="form-horizontal form-bordered ng-pristine ng-valid">
		<div class="form-body">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" ng-model="name" maxlength="25" id="maxlength_alloptions" ng-init="name='{{$menu->name}}'">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<div class="input-group">
			            <ui-select ng-model="permission.selected" theme="bootstrap" ng-init="permissions={{$permissions}};permission.selected={{$current_permission}}">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" ng-model="url" maxlength="25" id="maxlength_alloptions" ng-init="url='{{$menu->url}}'">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<div class="input-group">
			            <ui-select ng-model="parent.selected" theme="bootstrap" ng-init="parents={{$parents}};parent.selected={{$current_parent}}">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" ng-model="description" maxlength="25" id="maxlength_alloptions"  ng-init="description='{{$menu->description}}'">
