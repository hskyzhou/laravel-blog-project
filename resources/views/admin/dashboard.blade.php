				...
				<div class="portlet-body">
					...
					<div class="table-scrollable table-scrollable-borderless">
						<table class="table table-hover table-light">
							...
							<tr>
								<td class="fit">
									<img class="user-pic" src="{{asset('admin/layout/img/avatar4.jpg')}}">
								</td>
								<td>
							...
							<tr>
								<td class="fit">
									<img class="user-pic" src="{{asset('admin/layout/img/avatar5.jpg')}}">
								</td>
								<td>
							...
							<tr>
								<td class="fit">
									<img class="user-pic" src="{{asset('admin/layout/img/avatar6.jpg')}}">
								</td>
								<td>
							...
							<tr>
								<td class="fit">
									<img class="user-pic" src="{{asset('admin/layout/img/avatar7.jpg')}}">
								</td>
								<td>
					...
					<div class="scroller" style="height: 329px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
						<div class="general-item-list">
							<div class="item">
								<div class="item-head">
									<div class="item-details">
										<img class="item-pic" src="{{asset('admin/layout/img/avatar4.jpg')}}">
							...
							<div class="item">
								<div class="item-head">
									<div class="item-details">
										<img class="item-pic" src="{{asset('admin/layout/img/avatar3.jpg')}}">
							...
							<div class="item">
								<div class="item-head">
									<div class="item-details">
										<img class="item-pic" src="{{asset('admin/layout/img/avatar6.jpg')}}">
										<a href="" class="item-name primary-link">Nick Larson</a>
							...
							<div class="item">
								<div class="item-head">
									<div class="item-details">
										<img class="item-pic" src="{{asset('admin/layout/img/avatar7.jpg')}}">
										<a href="" class="item-name primary-link">Nick Larson</a>
							...
							<div class="item">
								<div class="item-head">
									<div class="item-details">
										<img class="item-pic" src="{{asset('admin/layout/img/avatar9.jpg')}}">
							...
							<div class="item">
								<div class="item-head">
									<div class="item-details">
										<img class="item-pic" src="{{asset('admin/layout/img/avatar8.jpg')}}">
							...
							<div class="item">
								<div class="item-head">
									<div class="item-details">
										<img class="item-pic" src="{{asset('admin/layout/img/avatar2.jpg')}}">
