{{-- 修改权限内容 --}}
<div class="init" ng-init="id='{{$permission->id}}'"></div>
	...
	<form class="form-horizontal form-bordered ng-pristine ng-valid">
		<div class="form-body">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" ng-model="name" maxlength="25" id="maxlength_alloptions" ng-init="name='{{$permission->name}}'">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" ng-model="slug" maxlength="25" id="maxlength_alloptions" ng-init="slug='{{$permission->slug}}'">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" ng-model="description" maxlength="25" id="maxlength_alloptions"  ng-init="description='{{$permission->description}}'">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" ng-model="model" maxlength="25" id="maxlength_alloptions" ng-init="model='{{$permission->model}}'">
