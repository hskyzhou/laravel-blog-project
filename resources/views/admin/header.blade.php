	...
	<div class="top-menu">
		<ul class="nav navbar-nav pull-right">
					...
					<li>
						<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
							...
							<li>
								<a href="#/profile/dashboard">
								<span class="photo">
								<img src="{{asset('admin/layout/img/avatar1.jpg')}}" class="img-circle" alt="">
								</span>
								<span class="subject">
								<span class="from">
								Bob Nilson </span>
			...
			<li class="dropdown dropdown-language hide">
				<a href="#" class="dropdown-toggle" dropdown-menu-hover data-toggle="dropdown" data-close-others="true">
				<img alt="" src="{{asset('global/img/flags/us.png')}}">
				<span class="langname">
				EN </span>
				...
				<ul class="dropdown-menu dropdown-menu-default">
					<li class="active">
						<a href="#">
						<img alt="" src="{{asset('global/img/flags/us.png')}}"> English </a>
					</li>
					<li>
						<a href="#">
						<img alt="" src="{{asset('global/img/flags/de.png')}}"> German </a>
					</li>
					<li>
						<a href="#">
						<img alt="" src="{{asset('global/img/flags/ru.png')}}"> Russian </a>
					</li>
					<li>	
						<a href="#">
						<img alt="" src="{{asset('global/img/flags/fr.png')}}"> French </a>
					</li>
				</ul>
			</li>
			<!-- END LANGUAGE BAR -->
