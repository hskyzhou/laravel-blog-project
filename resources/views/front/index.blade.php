...
@section('content')
	<div class="hsky-body">
		<div class="container">
			<div class="col-md-9 blogger" scrollable style="height:1500px" on-scroll-start="scroll_start()" on-scroll-end="scroll_end(X, Y)"  parameters='{"mouseWheel":true}' curr-page-x="currX" curr-page-y="currY">
